import { loadEmployeesVacationRequests } from "@/helpers/hr/vacation";
import { loadAgentsVacationRequests } from "@/helpers/wfm/vacation";
...
export async function GET(req) {
	...
	let requests = await loadAgentsVacationRequests(
